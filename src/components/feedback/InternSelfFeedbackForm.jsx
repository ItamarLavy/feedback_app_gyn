...
const PROCEDURE_CATEGORIES = {
  "אבנים בנשים": [
    "אדר חמרני", "אלומה בר", "אלון קס", "ג'ולנאר מוסטאפא", "גילה כהן",
    "דימא פארוג'ה", "דניאל ויקטור", "דר נוי", "מעיין יוגב", "נטלי ביבר",
    "פארוג'ה נטור דימא", "קארן הורביץ", "קרן מרקס", "שבית אסולין",
    "שלהבת פרנק", "שני מושקוביץ", "תמר אליישיב"
  ],
  "גלעד רונית": [
    "דן וולסקי", "דנה לסרי", "הלן מיסמה", "חגי אמסלם", "יהודית זנגי",
    "יובל לביא", "יעקב בנטוב", "ישי סומפולינסקי", "לויט לורין", "לילך מור",
    "מאור קבסה", "מיכל נובוסלסקי", "נעם כהן", "עובדיה רוזנבלו", "עפר בהריר",
    "פרץ אדווה", "צביקה שמעונוביץ", "רחל פרנקל", "אדר חמרני", "קרן מרקס", "שני מושקוביץ"
  ]
};
