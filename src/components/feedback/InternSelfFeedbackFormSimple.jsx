...
import { Send, CheckCircle, Info, Calendar, Hash } from 'lucide-react';
...
export default function InternSelfFeedbackFormSimple({ internId, internName, experts, onSuccess }) {
  ...
  const isValid = formData.expert_id && formData.procedure_category && 
            ...
            >
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex gap-2">
                ...
                <p className="text-sm text-amber-800">
                  דרג את עצמך בכל קטגוריה רלוונטית. יש לדרג לפחות קטגוריה אחת.
                </p>
              </div>
